...
let PlanDetailsComponent = class PlanDetailsComponent {
    constructor(_formBuilder, route, adminService, router, toastrService) {
        ...
        //  form model binding
        this.CariesForms = { Buccal: false, Distal: false, Lingual: false, Mesial: false, Occlusal: false };
        this.FractureForms = { Fracturevalue: '' };
        this.SeverelyDamagedForms = { SeverelyDamaged: false };
        this.WearForms = { Wearvalue: '' };
        this.PlaqueHygieneForms = { PlaqueHygienevalue: '' };
        this.GingivitisForms = { Gingivitisvalue: '' };
        this.GingivalRecessionForms = { GingivalRecessionvalue: '' };
        this.PeriodontitisForms = { Periodontitisvalue: '' };
        this.MobilityForms = { Mobilityvalue: '' };
        this.GummySmileForms = { GummySmile: false };
        this.GingivalOvergrowthForms = { GingivalOvergrowth: false };
        this.LargeMaxillarySinusForms = { LargeMaxillarySinus: false };
        this.NecrosisForms = { Necrosis: false };
        this.RootCanalTreatmentForms = { RootCanalTreatmentvalue: '' };
        this.ApicalLesioForms = { ApicalLesiovalue: '' };
        this.BrokenInstrumentinCanalForms = { BrokenInstrumentinCanal: false };
        this.RootResorptionForms = { External: false, Internal: false };
        this.MissingTeethForms = { MissingTeeth: false };
        this.ImplantForms = { OK: false, Malpositioned: false, Withboneloss: false, Withgingivalrecession: false };
        this.ImpactedTeethForms = { ImpactedTeeth: false };
        this.ImpactedInfectedTeethForms = { ImpactedInfectedTeeth: false };
        this.LargeMaxillarySinusForm = { LargeMaxillarySinus: false };
        this.VeneerForms = { Ok: false, Leaking: false, Worn: false, Fractured: false, Discolored: false, Unaesthetic: false };
        this.CrownForms = { Ok: false, Leaking: false, Worn: false, Fractured: false, Discolored: false, Unaesthetic: false };
        this.OnlayForms = { Ok: false, Leaking: false, Worn: false, Fractured: false, Discolored: false, Unaesthetic: false };
        this.BridgeForms = { Ok: false, Leaking: false, Worn: false, Fractured: false, Discolored: false, Unaesthetic: false };
        this.DentureForms = { Ok: false, Leaking: false, Worn: false, Fractured: false, Discolored: false, Unaesthetic: false };
        this.patientN = false;
        //  ------------checkbox hide-----------
        this.ok = false;
        this.other = false;
        ...
        this.spacing1 = true;
        this.spacing2 = false;
        this.posterior1 = true;
        this.posterior2 = false;
        this.skeletal1 = true;
        this.skeletal2 = false;
        this.oftHide = false;
        this.facial = false;
        this.malocclusion = false;
        this.tmj = false;
        // ----------------
        //  Caries array 
        this.cariesActive = false;
        this.caries = [];
        this.BuccalTeethActive = [];
        this.BuccalCSSarray = new Array();
        ...
        this.DistalTeethActive = [];
        this.DistalCSSarray = new Array();
        this.LingualTeethActive = [];
        this.LingualCSSarray = new Array();
        this.MesialTeethActive = [];
        this.MesialCSSarray = new Array();
        this.OcclusalTeethActive = [];
        this.OcclusalCSSarray = new Array();
        //  fracture section
        this.fractureActive = false;
        this.crownSection = false;
        this.rootSection = false;
        this.fractures = [];
        this.crownCSSarray = new Array();
        this.rootCSSarray = new Array();
        // SeverelyDamaged
        this.severalDamaged = false;
        this.severalDamagedLabel = [];
        this.severalDamagedCSSarray = new Array();
        //  wear section
        ...
        this.MildCSSarray = new Array();
        this.ModerateCSSarray = new Array();
        this.SevereCSSarray = new Array();
        // -------------------------Perio Bone Section----------------------
        this.PlaqueHygieneDegree = [];
        this.GingivitisDegree = [];
        this.MobilityDegree = [];
        this.GingivalRecessionactive = true;
        this.GingivalRecessionDegree = [];
        this.GingivalRecessionMild = false;
        this.GingivalRecessionMildCSSArray = new Array();
        this.GingivalRecessionModerate = false;
        this.GingivalRecessionModerateCSSArray = new Array();
        this.GingivalRecessionSevere = false;
        this.GingivalRecessionSevereCSSArray = new Array();
        this.PeriodontitisActive = true;
        this.PeriodontitisDegree = [];
        this.PeriodontitisMild = false;
        this.PeriodontitisMildCSSArray = new Array();
        this.PeriodontitisModerate = false;
        this.PeriodontitisModerateCSSArray = new Array();
        this.PeriodontitisSevere = false;
        this.PeriodontitisSevereCSSArray = new Array();
        this.GummSmileActive = false;
        this.GummSmileCSSArray = new Array();
        this.GingivalOvergrowthActive = false;
        this.GingivalOvergrowthCSSArray = new Array();
        // tab 3
        this.ApicalLesionDegree = [];
        this.necrosisCSSArray = new Array();
        this.necrosis = false;
        this.RootCanalTreatment = false;
        this.SatisfactoryCSSArray = new Array();
        this.saticfactory = false;
        this.UnsatisfactoryCSSArray = new Array();
        this.unsatisfactory = false;
        this.ApicalLesionMild = false;
        this.ApicalLesionMildCSSArray = new Array();
        this.ApicalLesionModerate = false;
        this.ApicalLesionModerateCSSArray = new Array();
        this.ApicalLesionSevere = false;
        this.ApicalLesionSevereCSSArray = new Array();
        this.BrokenInstrumentinCanal = false;
        this.BrokenInstrumentinCanalCSSArray = new Array();
        this.RootResorption = [];
        this.InternalCSSarray = new Array();
        this.Internalchecked = false;
        this.ExternalCSSarray = new Array();
        ...
        this.checkBoxValue = [];
        this.checkBoxOk = [];
        this.otherCSSArray = new Array();
        this.okCSSArray = new Array();
        this.teethhidden = false;
        this.MissingTeethActive = false;
        this.MissingTeethCSSArray = new Array();
        this.ImpactedTeethActive = false;
        this.ImpactedTeethCSSArray = new Array();
        this.ImpactedInfectedTeethActive = false;
        this.ImpactedInfectedTeethCSSArray = new Array();
        this.LargeMaxillarySinusActive = false;
        this.LargeMaxillarySinusCSSArray = new Array();
        // tab 6
        this.postokCSSArray = new Array();
        this.postok = false;
        this.postunsatisfactoryCSSArray = new Array();
        this.postunsatisfactory = false;
        this.DiscoloredTeethActive = false;
        this.DiscoloredCSSArray = new Array();
        // tab 7
        this.vOk = false;
        this.vLeaking = false;
        this.vWorn = false;
        this.vFractured = false;
        this.vDiscolored = false;
        this.vUnaesthetic = false;
        this.veneerok = false;
        this.veneerother = false;
        this.veneercheckBoxValue = [];
        this.veneercheckBoxOk = [];
        this.veneerotherCSSArray = new Array();
        this.veneerokCSSArray = new Array();
        this.cOk = false;
        this.cLeaking = false;
        this.cWorn = false;
        this.cFractured = false;
        this.cDiscolored = false;
        this.cUnaesthetic = false;
        this.crownok = false;
        this.crownother = false;
        this.crowncheckBoxValue = [];
        this.crowncheckBoxOk = [];
        this.crownotherCSSArray = new Array();
        this.crownokCSSArray = new Array();
        this.oOk = false;
        this.oLeaking = false;
        this.oWorn = false;
        this.oFractured = false;
        this.oDiscolored = false;
        this.oUnaesthetic = false;
        this.onlayok = false;
        this.onlayother = false;
        this.onlaycheckBoxValue = [];
        this.onlaycheckBoxOk = [];
        this.onlayotherCSSArray = new Array();
        this.onlayokCSSArray = new Array();
        this.bridgeok = false;
        ...
        this.ROK = false;
        this.ROther = false;
        this.RestorativeOk = false;
        this.RestorativeOther = false;
        this.RColor = [];
        this.ColorBuccalchecked = false;
        this.ColorBuccalCSSArray = new Array();
        this.ColorDistalchecked = false;
        this.ColorDistalCSSArray = new Array();
        this.ColorLingualchecked = false;
        this.ColorLingualCSSArray = new Array();
        this.ColorMesialchecked = false;
        this.ColorMesialCSSArray = new Array();
        this.ColorOcclusalchecked = false;
        this.ColorOcclusalCSSArray = new Array();
    ...
    ngOnInit() {
        if (this.PatientID !== null || this.PatientID !== undefined) {
            this.adminService.getByID('getPlanByID', this.PatientID).subscribe(data => {
    ...
    validate(mode, teethValue) {
        ...
        if (this.rootSection === true) {
            this.rootCSSarray[18] = true;
        }
        if (this.crownSection === true) {
            this.crownCSSarray[18] = true;
        }
        if (this.severalDamaged === true) {
            this.severalDamagedCSSarray[18] = true;
        }
        if (this.MildSection === true) {
            this.MildCSSarray[18] = true;
        }
        if (this.ModerateSection === true) {
            this.ModerateCSSarray[18] = true;
        }
        if (this.SevereSection === true) {
            this.SevereCSSarray[18] = true;
        }
        // 
        if (this.GingivalRecessionMild === true) {
            this.GingivalRecessionMildCSSArray[18] = true;
        }
        if (this.GingivalRecessionModerate === true) {
            this.GingivalRecessionModerateCSSArray[18] = true;
        }
        if (this.GingivalRecessionSevere === true) {
            this.GingivalRecessionSevereCSSArray[18] = true;
        }
    ...
    validateTooth17(mode, teethValue) {
        if (this.teeth17 === false) {
            ...
            if (this.Mesialchecked === true) {
                this.MesialCSSarray[17] = true;
            }
            if (this.Distalchecked === true) {
                this.DistalCSSarray[17] = true;
            }
            if (this.Lingualchecked === true) {
                this.LingualCSSarray[17] = true;
            }
            if (this.Occlusalchecked === true) {
                this.OcclusalCSSarray[17] = true;
            }
            if (this.Buccalchecked === true) {
                this.BuccalCSSarray[17] = true;
            }
            if (this.rootSection === true) {
                this.rootCSSarray[17] = true;
            }
            if (this.crownSection === true) {
                this.crownCSSarray[17] = true;
            }
            if (this.severalDamaged === true) {
                this.severalDamagedCSSarray[17] = true;
            }
            if (this.MildSection === true) {
                this.MildCSSarray[17] = true;
            }
            if (this.ModerateSection === true) {
                this.ModerateCSSarray[17] = true;
            }
            if (this.SevereSection === true) {
                this.SevereCSSarray[17] = true;
            }
            if (this.GingivalRecessionMild === true) {
                this.GingivalRecessionMildCSSArray[17] = true;
            }
            if (this.GingivalRecessionModerate === true) {
                this.GingivalRecessionModerateCSSArray[17] = true;
            }
            if (this.GingivalRecessionSevere === true) {
                this.GingivalRecessionSevereCSSArray[17] = true;
            }
            if (this.PeriodontitisMild === true) {
    ...
    validateTooth16(mode, teethValue) {
        if (this.teeth16 === false) {
            ...
            this.selectedTeethValue.push(teethValue);
            if (this.Mesialchecked === true) {
                this.MesialCSSarray[16] = true;
            }
            if (this.Distalchecked === true) {
                this.DistalCSSarray[16] = true;
            }
            if (this.Lingualchecked === true) {
                this.LingualCSSarray[16] = true;
            }
            if (this.Occlusalchecked === true) {
                this.OcclusalCSSarray[16] = true;
            }
            if (this.Buccalchecked === true) {
                this.BuccalCSSarray[16] = true;
            }
            if (this.rootSection === true) {
                this.rootCSSarray[16] = true;
            }
            if (this.crownSection === true) {
                this.crownCSSarray[16] = true;
            }
            if (this.severalDamaged === true) {
                this.severalDamagedCSSarray[16] = true;
            }
            if (this.MildSection === true) {
                this.MildCSSarray[16] = true;
            }
            if (this.ModerateSection === true) {
                this.ModerateCSSarray[16] = true;
            }
            if (this.SevereSection === true) {
                this.SevereCSSarray[16] = true;
            }
            if (this.GingivalRecessionMild === true) {
                this.GingivalRecessionMildCSSArray[16] = true;
            }
            if (this.GingivalRecessionModerate === true) {
                this.GingivalRecessionModerateCSSArray[16] = true;
            }
            if (this.GingivalRecessionSevere === true) {
                this.GingivalRecessionSevereCSSArray[16] = true;
            }
            if (this.PeriodontitisMild === true) {
    ...
    validateTooth15(mode, teethValue) {
        if (this.teeth15 === false) {
            ...
            this.selectedTeethValue.push(teethValue);
            if (this.Mesialchecked === true) {
                this.MesialCSSarray[15] = true;
            }
            if (this.Distalchecked === true) {
                this.DistalCSSarray[15] = true;
            }
            if (this.Lingualchecked === true) {
                this.LingualCSSarray[15] = true;
            }
            if (this.Occlusalchecked === true) {
                this.OcclusalCSSarray[15] = true;
            }
            if (this.Buccalchecked === true) {
                this.BuccalCSSarray[15] = true;
            }
            if (this.rootSection === true) {
                this.rootCSSarray[15] = true;
            }
            if (this.crownSection === true) {
                this.crownCSSarray[15] = true;
            }
            if (this.severalDamaged === true) {
                this.severalDamagedCSSarray[15] = true;
            }
            if (this.MildSection === true) {
                this.MildCSSarray[15] = true;
            }
            if (this.ModerateSection === true) {
                this.ModerateCSSarray[15] = true;
            }
            if (this.SevereSection === true) {
                this.SevereCSSarray[15] = true;
            }
            if (this.GingivalRecessionMild === true) {
                this.GingivalRecessionMildCSSArray[15] = true;
            }
            if (this.GingivalRecessionModerate === true) {
                this.GingivalRecessionModerateCSSArray[15] = true;
            }
            if (this.GingivalRecessionSevere === true) {
                this.GingivalRecessionSevereCSSArray[15] = true;
            }
            if (this.PeriodontitisMild === true) {
    ...
    validateTooth14(mode, teethValue) {
        if (this.teeth14 === false) {
            ...
            this.selectedTeethValue.push(teethValue);
            if (this.Mesialchecked === true) {
                this.MesialCSSarray[14] = true;
            }
            if (this.Distalchecked === true) {
                this.DistalCSSarray[14] = true;
            }
            if (this.Lingualchecked === true) {
                this.LingualCSSarray[14] = true;
            }
            if (this.Occlusalchecked === true) {
                this.OcclusalCSSarray[14] = true;
            }
            if (this.Buccalchecked === true) {
                this.BuccalCSSarray[14] = true;
            }
            if (this.rootSection === true) {
                this.rootCSSarray[14] = true;
            }
            if (this.crownSection === true) {
                this.crownCSSarray[14] = true;
            }
            if (this.severalDamaged === true) {
                this.severalDamagedCSSarray[14] = true;
            }
            if (this.MildSection === true) {
                this.MildCSSarray[14] = true;
            }
            if (this.ModerateSection === true) {
                this.ModerateCSSarray[14] = true;
            }
            if (this.SevereSection === true) {
                this.SevereCSSarray[14] = true;
            }
            if (this.GingivalRecessionMild === true) {
                this.GingivalRecessionMildCSSArray[14] = true;
            }
            if (this.GingivalRecessionModerate === true) {
                this.GingivalRecessionModerateCSSArray[14] = true;
            }
            if (this.GingivalRecessionSevere === true) {
                this.GingivalRecessionSevereCSSArray[14] = true;
            }
            if (this.PeriodontitisMild === true) {
    ...
    validateTooth13(mode, teethValue) {
        if (this.teeth13 === false) {
            ...
            this.selectedTeethValue.push(teethValue);
            if (this.Mesialchecked === true) {
                this.MesialCSSarray[13] = true;
            }
            if (this.Distalchecked === true) {
                this.DistalCSSarray[13] = true;
            }
            if (this.Lingualchecked === true) {
                this.LingualCSSarray[13] = true;
            }
            if (this.Occlusalchecked === true) {
                this.OcclusalCSSarray[13] = true;
            }
            if (this.Buccalchecked === true) {
                this.BuccalCSSarray[13] = true;
            }
            if (this.rootSection === true) {
                this.rootCSSarray[13] = true;
            }
            if (this.crownSection === true) {
                this.crownCSSarray[13] = true;
            }
            if (this.severalDamaged === true) {
                this.severalDamagedCSSarray[13] = true;
            }
            if (this.MildSection === true) {
                this.MildCSSarray[13] = true;
            }
            if (this.ModerateSection === true) {
                this.ModerateCSSarray[13] = true;
            }
            if (this.SevereSection === true) {
                this.SevereCSSarray[13] = true;
            }
            if (this.GingivalRecessionMild === true) {
                this.GingivalRecessionMildCSSArray[13] = true;
            }
            if (this.GingivalRecessionModerate === true) {
                this.GingivalRecessionModerateCSSArray[13] = true;
            }
            if (this.GingivalRecessionSevere === true) {
                this.GingivalRecessionSevereCSSArray[13] = true;
            }
            if (this.PeriodontitisMild === true) {
    ...
    validateTooth12(mode, teethValue) {
        if (this.teeth12 === false) {
            ...
            this.selectedTeethValue.push(teethValue);
            if (this.Mesialchecked === true) {
                this.MesialCSSarray[12] = true;
            }
            if (this.Distalchecked === true) {
                this.DistalCSSarray[12] = true;
            }
            if (this.Lingualchecked === true) {
                this.LingualCSSarray[12] = true;
            }
            if (this.Occlusalchecked === true) {
                this.OcclusalCSSarray[12] = true;
            }
            if (this.Buccalchecked === true) {
                this.BuccalCSSarray[12] = true;
            }
            if (this.rootSection === true) {
                this.rootCSSarray[12] = true;
            }
            if (this.crownSection === true) {
                this.crownCSSarray[12] = true;
            }
            if (this.severalDamaged === true) {
                this.severalDamagedCSSarray[12] = true;
            }
            if (this.MildSection === true) {
                this.MildCSSarray[12] = true;
            }
            if (this.ModerateSection === true) {
                this.ModerateCSSarray[12] = true;
            }
            if (this.SevereSection === true) {
                this.SevereCSSarray[12] = true;
            }
            if (this.GingivalRecessionMild === true) {
                this.GingivalRecessionMildCSSArray[12] = true;
            }
            if (this.GingivalRecessionModerate === true) {
                this.GingivalRecessionModerateCSSArray[12] = true;
            }
            if (this.GingivalRecessionSevere === true) {
                this.GingivalRecessionSevereCSSArray[12] = true;
            }
            if (this.PeriodontitisMild === true) {
    ...
    validateTooth11(mode, teethValue) {
        if (this.teeth11 === false) {
            ...
            this.selectedTeethValue.push(teethValue);
            if (this.Mesialchecked === true) {
                this.MesialCSSarray[11] = true;
            }
            if (this.Distalchecked === true) {
                this.DistalCSSarray[11] = true;
            }
            if (this.Lingualchecked === true) {
                this.LingualCSSarray[11] = true;
            }
            if (this.Occlusalchecked === true) {
                this.OcclusalCSSarray[11] = true;
            }
            if (this.Buccalchecked === true) {
                this.BuccalCSSarray[11] = true;
            }
            if (this.rootSection === true) {
                this.rootCSSarray[11] = true;
            }
            if (this.crownSection === true) {
                this.crownCSSarray[11] = true;
            }
            if (this.severalDamaged === true) {
                this.severalDamagedCSSarray[11] = true;
            }
            if (this.MildSection === true) {
                this.MildCSSarray[11] = true;
            }
            if (this.ModerateSection === true) {
                this.ModerateCSSarray[11] = true;
            }
            if (this.SevereSection === true) {
                this.SevereCSSarray[11] = true;
            }
            if (this.GingivalRecessionMild === true) {
                this.GingivalRecessionMildCSSArray[11] = true;
            }
            if (this.GingivalRecessionModerate === true) {
                this.GingivalRecessionModerateCSSArray[11] = true;
            }
            if (this.GingivalRecessionSevere === true) {
                this.GingivalRecessionSevereCSSArray[11] = true;
            }
            if (this.PeriodontitisMild === true) {
    ...
    teeth(mode, teethValue) {
        ...
        if (mode === 'tooth34') {
            if (this.teeth34 === false) {
                ...
                if (this.unsatisfactory === true) {
                    this.UnsatisfactoryCSSArray[34] = true;
                }
                if (this.ApicalLesionMild === true) {
                    this.ApicalLesionMildCSSArray[34] = true;
                }
                if (this.ApicalLesionModerate === true) {
                    this.ApicalLesionModerateCSSArray[34] = true;
                }
                if (this.ApicalLesionSevere === true) {
                    this.ApicalLesionSevereCSSArray[34] = true;
                }
                if (this.BrokenInstrumentinCanal === true) {
                    this.BrokenInstrumentinCanalCSSArray[34] = true;
                }
                if (this.Internalchecked === true) {
                    this.InternalCSSarray[34] = true;
                }
                if (this.Externalchecked === true) {
                    this.ExternalCSSarray[34] = true;
                }
                if (this.MissingTeethActive === true) {
        ...
        if (mode === 'tooth37') {
            if (this.teeth37 === false) {
                ...
                if (this.ApicalLesionMild === true) {
                    this.ApicalLesionMildCSSArray[37] = true;
                }
                if (this.ApicalLesionModerate === true) {
    ...
    resetshowOFT() { if (this.oftHide === true) {
        this.oftHide = false;
        this.malocclusion = false;
        this.tmj = false;
        this.facial = false;
    ...
    Button1() {
        if (this.classII === false && this.classI === true) {
            this.classI = false;
            this.classII = true;
        }
        ...
        else if (this.classII === true && this.classI === false) {
            this.classI = true;
            this.classII = false;
        }
    }
    Button2() {
        if (this.classIII === false && this.classI === true) {
            this.classI = false;
            this.classIII = true;
        }
        else if (this.classII === true && this.classI === false) {
    ...
    buttonT1() {
        if (this.class2 === false && this.class1 === true) {
            this.class1 = false;
            this.class2 = true;
        }
        ...
        else if (this.class2 === true && this.class1 === false) {
            this.class1 = true;
            this.class2 = false;
        }
    }
    buttonT2() {
        if (this.class3 === false && this.class1 === true) {
            this.class1 = false;
            this.class3 = true;
        }
        else if (this.class2 === true && this.class1 === false) {
    ...
    buttonT11() {
        if (this.class12 === false && this.class11 === true) {
            this.class11 = false;
            this.class12 = true;
        }
        else if (this.class13 === true && this.class11 === false) {
            this.class12 = true;
            this.class11 = false;
            this.class13 = false;
        }
        else if (this.class12 === true && this.class11 === false) {
            this.class11 = true;
            this.class12 = false;
        }
    }
    buttonT12() {
        if (this.class13 === false && this.class11 === true) {
            this.class11 = false;
            this.class13 = true;
        }
        else if (this.class12 === true && this.class11 === false) {
    ...
    Button12() {
        if (this.crowding2 === false) {
            this.crowding2 = true;
            this.crowding1 = false;
        }
        else {
            this.crowding2 = false;
            this.crowding1 = true;
    ...
    Button14() {
        if (this.posterior2 === false) {
            this.posterior2 = true;
            this.posterior1 = false;
        }
        else {
            this.posterior2 = false;
            this.posterior1 = true;
    ...
    Button15() {
        if (this.skeletal2 === false) {
            this.skeletal2 = true;
            this.skeletal1 = false;
        }
        else {
            this.skeletal2 = false;
            this.skeletal1 = true;
    ...
    fracture(event, value) {
        ...
        if (value === 'Crown') {
            ...
            if (findvalue === -1) {
                this.fractures.push(value);
            }
            if (findDvalue !== -1) {
                this.fractures.splice(findDvalue, 1);
            }
    ...
    SeverelyDamaged() {
        ...
        if (findvalue === -1) {
            this.severalDamagedLabel.push('Severely Damaged');
        }
        if (this.selectedTeethValue.length > 0) {
            for (var i = 0; i < this.selectedTeethValue.length; i++) {
    ...
    Wear(value) {
        ...
        if (value === 'Mild') {
            ...
            if (findvalue === -1) {
                this.wear.push(value);
            }
            if (findSevereDvalue !== -1) {
                this.wear.splice(findSevereDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.wear.splice(findModeratevalue, 1);
            }
            ...
            if (findMildvalue !== -1) {
                this.wear.splice(findMildvalue, 1);
            }
            ...
            if (findModerateDvalue !== -1) {
                this.wear.splice(findModerateDvalue, 1);
            }
            if (findMildvalue !== -1) {
                this.wear.splice(findMildvalue, 1);
            }
    ...
    PlaqueHygiene(value) {
        if (value === 'Mild') {
            ...
            if (findvalue === -1) {
                this.PlaqueHygieneDegree.push(value);
            }
            if (findSevereDvalue !== -1) {
                this.PlaqueHygieneDegree.splice(findSevereDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.PlaqueHygieneDegree.splice(findModeratevalue, 1);
            }
        }
        else if (value === 'Severe') {
            const findvalue = this.wear.indexOf('Severe');
            ...
            if (findMildDvalue !== -1) {
                this.PlaqueHygieneDegree.splice(findMildDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.PlaqueHygieneDegree.splice(findModeratevalue, 1);
            }
    ...
    Gingivitis(value) {
        if (value === 'Mild') {
            ...
            if (findvalue === -1) {
                this.GingivitisDegree.push(value);
            }
            if (findSevereDvalue !== -1) {
                this.GingivitisDegree.splice(findSevereDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.GingivitisDegree.splice(findModeratevalue, 1);
            }
        }
        else if (value === 'Severe') {
            ...
            if (findMildDvalue !== -1) {
                this.GingivitisDegree.splice(findMildDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.GingivitisDegree.splice(findModeratevalue, 1);
            }
    ...
    GingivalRecession(value) {
        if (value === 'Mild') {
            ...
            if (findvalue === -1) {
                this.GingivalRecessionDegree.push(value);
            }
            if (findSevereDvalue !== -1) {
                this.GingivalRecessionDegree.splice(findSevereDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.GingivalRecessionDegree.splice(findModeratevalue, 1);
            }
            ...
            if (findMildDvalue !== -1) {
                this.GingivalRecessionDegree.splice(findMildDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.GingivalRecessionDegree.splice(findModeratevalue, 1);
            }
    ...
    Periodontitis(value) {
        if (value === 'Mild') {
            ...
            if (findvalue === -1) {
                this.PeriodontitisDegree.push(value);
            }
            if (findSevereDvalue !== -1) {
                this.PeriodontitisDegree.splice(findSevereDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.PeriodontitisDegree.splice(findModeratevalue, 1);
            }
            ...
            if (findMildDvalue !== -1) {
                this.PeriodontitisDegree.splice(findMildDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.PeriodontitisDegree.splice(findModeratevalue, 1);
            }
    ...
    Mobility(value) {
        if (value === 'Mild') {
            ...
            if (findvalue === -1) {
                this.MobilityDegree.push(value);
            }
            if (findSevereDvalue !== -1) {
                this.MobilityDegree.splice(findSevereDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.MobilityDegree.splice(findModeratevalue, 1);
            }
        }
        else if (value === 'Severe') {
            ...
            if (findMildDvalue !== -1) {
                this.MobilityDegree.splice(findMildDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.MobilityDegree.splice(findModeratevalue, 1);
            }
    ...
    ApicalLesion(value) {
        if (value === 'Mild') {
            ...
            if (findvalue === -1) {
                this.ApicalLesionDegree.push(value);
            }
            if (findSevereDvalue !== -1) {
                this.ApicalLesionDegree.splice(findSevereDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.ApicalLesionDegree.splice(findModeratevalue, 1);
            }
            ...
            if (findMildDvalue !== -1) {
                this.ApicalLesionDegree.splice(findMildDvalue, 1);
            }
            if (findModeratevalue !== -1) {
                this.ApicalLesionDegree.splice(findModeratevalue, 1);
            }
    ...
    vaneerFnValue(mode) {
        if (mode === 'tooth18') {
            if (this.teeth18 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[18] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[18] = true;
                }
            }
            else {
                this.veneerokCSSArray[18] = false;
                this.veneerotherCSSArray[18] = false;
            }
        }
        if (mode === 'tooth17') {
            if (this.teeth17 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[17] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[17] = true;
                }
            }
            else {
                this.veneerokCSSArray[17] = false;
                this.veneerotherCSSArray[17] = false;
            }
        }
        if (mode === 'tooth16') {
            if (this.teeth16 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[16] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[16] = true;
                }
            }
            else {
                this.veneerokCSSArray[16] = false;
                this.veneerotherCSSArray[16] = false;
            }
        }
        if (mode === 'tooth15') {
            if (this.teeth15 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[15] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[15] = true;
                }
            }
            else {
                this.veneerokCSSArray[15] = false;
                this.veneerotherCSSArray[15] = false;
            }
        }
        if (mode === 'tooth14') {
            if (this.teeth14 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[14] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[14] = true;
                }
            }
            else {
                this.veneerokCSSArray[14] = false;
                this.veneerotherCSSArray[14] = false;
            }
        }
        if (mode === 'tooth13') {
            if (this.teeth13 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[13] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[13] = true;
                }
            }
            else {
                this.veneerokCSSArray[13] = false;
                this.veneerotherCSSArray[13] = false;
            }
        }
        if (mode === 'tooth12') {
            if (this.teeth12 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[12] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[12] = true;
                }
            }
            else {
                this.veneerokCSSArray[12] = false;
                this.veneerotherCSSArray[12] = false;
            }
        }
        if (mode === 'tooth11') {
            if (this.teeth11 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[11] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[11] = true;
                }
            }
            else {
                this.veneerokCSSArray[11] = false;
                this.veneerotherCSSArray[11] = false;
            }
        }
        if (mode === 'tooth21') {
            if (this.teeth21 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[21] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[21] = true;
                }
            }
            else {
                this.veneerokCSSArray[21] = false;
                this.veneerotherCSSArray[21] = false;
            }
        }
        if (mode === 'tooth22') {
            if (this.teeth22 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[22] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[22] = true;
                }
            }
            else {
                this.veneerokCSSArray[22] = false;
                this.veneerotherCSSArray[22] = false;
            }
        }
        if (mode === 'tooth23') {
            if (this.teeth23 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[23] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[23] = true;
                }
            }
            else {
                this.veneerokCSSArray[23] = false;
                this.veneerotherCSSArray[23] = false;
            }
        }
        if (mode === 'tooth24') {
            if (this.teeth24 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[24] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[24] = true;
                }
            }
            else {
                this.veneerokCSSArray[24] = false;
                this.veneerotherCSSArray[24] = false;
            }
        }
        if (mode === 'tooth25') {
            if (this.teeth25 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[25] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[25] = true;
                }
            }
            else {
                this.veneerokCSSArray[25] = false;
                this.veneerotherCSSArray[25] = false;
            }
        }
        if (mode === 'tooth26') {
            if (this.teeth26 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[26] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[26] = true;
                }
            }
            else {
                this.veneerokCSSArray[26] = false;
                this.veneerotherCSSArray[26] = false;
            }
        }
        if (mode === 'tooth27') {
            if (this.teeth27 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[27] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[27] = true;
                }
            }
            else {
                this.veneerokCSSArray[27] = false;
                this.veneerotherCSSArray[27] = false;
            }
        }
        if (mode === 'tooth28') {
            if (this.teeth28 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[28] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[28] = true;
                }
            }
            else {
                this.veneerokCSSArray[28] = false;
                this.veneerotherCSSArray[28] = false;
            }
        }
        if (mode === 'tooth48') {
            if (this.teeth48 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[48] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[48] = true;
                }
            }
            else {
                this.veneerokCSSArray[48] = false;
                this.veneerotherCSSArray[48] = false;
            }
        }
        if (mode === 'tooth47') {
            if (this.teeth47 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[47] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[47] = true;
                }
            }
            else {
                this.veneerokCSSArray[47] = false;
                this.veneerotherCSSArray[47] = false;
            }
        }
        if (mode === 'tooth46') {
            if (this.teeth46 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[46] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[46] = true;
                }
            }
            else {
                this.veneerokCSSArray[46] = false;
                this.veneerotherCSSArray[46] = false;
            }
        }
        if (mode === 'tooth45') {
            if (this.teeth45 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[45] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[45] = true;
                }
            }
            else {
                this.veneerokCSSArray[45] = false;
                this.veneerotherCSSArray[45] = false;
            }
        }
        if (mode === 'tooth44') {
            if (this.teeth44 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[44] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[44] = true;
                }
            }
            else {
                this.veneerokCSSArray[44] = false;
                this.veneerotherCSSArray[44] = false;
            }
        }
        if (mode === 'tooth43') {
            if (this.teeth43 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[43] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[43] = true;
                }
            }
            else {
                this.veneerokCSSArray[43] = false;
                this.veneerotherCSSArray[43] = false;
            }
        }
        if (mode === 'tooth42') {
            if (this.teeth42 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[42] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[42] = true;
                }
            }
            else {
                this.veneerokCSSArray[42] = false;
                this.veneerotherCSSArray[42] = false;
            }
        }
        if (mode === 'tooth41') {
            if (this.teeth41 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[41] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[41] = true;
                }
            }
            else {
                this.veneerokCSSArray[41] = false;
                this.veneerotherCSSArray[41] = false;
            }
        }
        if (mode === 'tooth31') {
            if (this.teeth31 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[31] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[31] = true;
                }
            }
            else {
                this.veneerokCSSArray[31] = false;
                this.veneerotherCSSArray[31] = false;
            }
        }
        if (mode === 'tooth32') {
            if (this.teeth32 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[32] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[32] = true;
                }
            }
            else {
                this.veneerokCSSArray[32] = false;
                this.veneerotherCSSArray[32] = false;
            }
        }
        if (mode === 'tooth33') {
            if (this.teeth33 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[33] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[33] = true;
                }
            }
            else {
                this.veneerokCSSArray[33] = false;
                this.veneerotherCSSArray[33] = false;
            }
        }
        if (mode === 'tooth34') {
            if (this.teeth34 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[34] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[34] = true;
                }
            }
            else {
                this.veneerokCSSArray[34] = false;
                this.veneerotherCSSArray[34] = false;
            }
        }
        if (mode === 'tooth35') {
            if (this.teeth35 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[35] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[35] = true;
                }
            }
            else {
                this.veneerokCSSArray[35] = false;
                this.veneerotherCSSArray[35] = false;
            }
        }
        if (mode === 'tooth36') {
            if (this.teeth36 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[36] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[36] = true;
                }
            }
            else {
                this.veneerokCSSArray[36] = false;
                this.veneerotherCSSArray[36] = false;
            }
        }
        if (mode === 'tooth37') {
            if (this.teeth37 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[37] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[37] = true;
                }
            }
            else {
                this.veneerokCSSArray[37] = false;
                this.veneerotherCSSArray[37] = false;
            }
        }
        if (mode === 'tooth38') {
            if (this.teeth38 === false) {
                if (this.veneerok === true) {
                    this.veneerokCSSArray[38] = true;
                }
                if (this.veneerother === true) {
                    this.veneerotherCSSArray[38] = true;
                }
            }
            else {
                this.veneerokCSSArray[38] = false;
                this.veneerotherCSSArray[38] = false;
            }
        }
    }
    ...
    crownFnValue(mode) {
        if (mode === 'tooth18') {
            if (this.teeth18 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[18] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[18] = true;
                }
            }
            else {
                this.crownokCSSArray[18] = false;
                this.crownotherCSSArray[18] = false;
            }
        }
        if (mode === 'tooth17') {
            if (this.teeth17 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[17] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[17] = true;
                }
            }
            else {
                this.crownokCSSArray[17] = false;
                this.crownotherCSSArray[17] = false;
            }
        }
        if (mode === 'tooth16') {
            if (this.teeth16 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[16] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[16] = true;
                }
            }
            else {
                this.crownokCSSArray[16] = false;
                this.crownotherCSSArray[16] = false;
            }
        }
        if (mode === 'tooth15') {
            if (this.teeth15 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[15] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[15] = true;
                }
            }
            else {
                this.crownokCSSArray[15] = false;
                this.crownotherCSSArray[15] = false;
            }
        }
        if (mode === 'tooth14') {
            if (this.teeth14 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[14] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[14] = true;
                }
            }
            else {
                this.crownokCSSArray[14] = false;
                this.crownotherCSSArray[14] = false;
            }
        }
        if (mode === 'tooth13') {
            if (this.teeth13 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[13] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[13] = true;
                }
            }
            else {
                this.crownokCSSArray[13] = false;
                this.crownotherCSSArray[13] = false;
            }
        }
        if (mode === 'tooth12') {
            if (this.teeth12 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[12] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[12] = true;
                }
            }
            else {
                this.crownokCSSArray[12] = false;
                this.crownotherCSSArray[12] = false;
            }
        }
        if (mode === 'tooth11') {
            if (this.teeth11 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[11] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[11] = true;
                }
            }
            else {
                this.crownokCSSArray[11] = false;
                this.crownotherCSSArray[11] = false;
            }
        }
        if (mode === 'tooth21') {
            if (this.teeth21 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[21] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[21] = true;
                }
            }
            else {
                this.crownokCSSArray[21] = false;
                this.crownotherCSSArray[21] = false;
            }
        }
        if (mode === 'tooth22') {
            if (this.teeth22 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[22] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[22] = true;
                }
            }
            else {
                this.crownokCSSArray[22] = false;
                this.crownotherCSSArray[22] = false;
            }
        }
        if (mode === 'tooth23') {
            if (this.teeth23 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[23] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[23] = true;
                }
            }
            else {
                this.crownokCSSArray[23] = false;
                this.crownotherCSSArray[23] = false;
            }
        }
        if (mode === 'tooth24') {
            if (this.teeth24 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[24] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[24] = true;
                }
            }
            else {
                this.crownokCSSArray[24] = false;
                this.crownotherCSSArray[24] = false;
            }
        }
        if (mode === 'tooth25') {
            if (this.teeth25 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[25] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[25] = true;
                }
            }
            else {
                this.crownokCSSArray[25] = false;
                this.crownotherCSSArray[25] = false;
            }
        }
        if (mode === 'tooth26') {
            if (this.teeth26 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[26] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[26] = true;
                }
            }
            else {
                this.crownokCSSArray[26] = false;
                this.crownotherCSSArray[26] = false;
            }
        }
        if (mode === 'tooth27') {
            if (this.teeth27 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[27] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[27] = true;
                }
            }
            else {
                this.crownokCSSArray[27] = false;
                this.crownotherCSSArray[27] = false;
            }
        }
        if (mode === 'tooth28') {
            if (this.teeth28 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[28] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[28] = true;
                }
            }
            else {
                this.crownokCSSArray[28] = false;
                this.crownotherCSSArray[28] = false;
            }
        }
        if (mode === 'tooth48') {
            if (this.teeth48 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[48] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[48] = true;
                }
            }
            else {
                this.crownokCSSArray[48] = false;
                this.crownotherCSSArray[48] = false;
            }
        }
        if (mode === 'tooth47') {
            if (this.teeth47 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[47] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[47] = true;
                }
            }
            else {
                this.crownokCSSArray[47] = false;
                this.crownotherCSSArray[47] = false;
            }
        }
        if (mode === 'tooth46') {
            if (this.teeth46 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[46] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[46] = true;
                }
            }
            else {
                this.crownokCSSArray[46] = false;
                this.crownotherCSSArray[46] = false;
            }
        }
        if (mode === 'tooth45') {
            if (this.teeth45 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[45] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[45] = true;
                }
            }
            else {
                this.crownokCSSArray[45] = false;
                this.crownotherCSSArray[45] = false;
            }
        }
        if (mode === 'tooth44') {
            if (this.teeth44 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[44] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[44] = true;
                }
            }
            else {
                this.crownokCSSArray[44] = false;
                this.crownotherCSSArray[44] = false;
            }
        }
        if (mode === 'tooth43') {
            if (this.teeth43 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[43] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[43] = true;
                }
            }
            else {
                this.crownokCSSArray[43] = false;
                this.crownotherCSSArray[43] = false;
            }
        }
        if (mode === 'tooth42') {
            if (this.teeth42 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[42] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[42] = true;
                }
            }
            else {
                this.crownokCSSArray[42] = false;
                this.crownotherCSSArray[42] = false;
            }
        }
        if (mode === 'tooth41') {
            if (this.teeth41 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[41] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[41] = true;
                }
            }
            else {
                this.crownokCSSArray[41] = false;
                this.crownotherCSSArray[41] = false;
            }
        }
        if (mode === 'tooth31') {
            if (this.teeth31 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[31] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[31] = true;
                }
            }
            else {
                this.crownokCSSArray[31] = false;
                this.crownotherCSSArray[31] = false;
            }
        }
        if (mode === 'tooth32') {
            if (this.teeth32 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[32] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[32] = true;
                }
            }
            else {
                this.crownokCSSArray[32] = false;
                this.crownotherCSSArray[32] = false;
            }
        }
        if (mode === 'tooth33') {
            if (this.teeth33 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[33] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[33] = true;
                }
            }
            else {
                this.crownokCSSArray[33] = false;
                this.crownotherCSSArray[33] = false;
            }
        }
        if (mode === 'tooth34') {
            if (this.teeth34 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[34] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[34] = true;
                }
            }
            else {
                this.crownokCSSArray[34] = false;
                this.crownotherCSSArray[34] = false;
            }
        }
        if (mode === 'tooth35') {
            if (this.teeth35 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[35] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[35] = true;
                }
            }
            else {
                this.crownokCSSArray[35] = false;
                this.crownotherCSSArray[35] = false;
            }
        }
        if (mode === 'tooth36') {
            if (this.teeth36 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[36] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[36] = true;
                }
            }
            else {
                this.crownokCSSArray[36] = false;
                this.crownotherCSSArray[36] = false;
            }
        }
        if (mode === 'tooth37') {
            if (this.teeth37 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[37] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[37] = true;
                }
            }
            else {
                this.crownokCSSArray[37] = false;
                this.crownotherCSSArray[37] = false;
            }
        }
        if (mode === 'tooth38') {
            if (this.teeth38 === false) {
                if (this.crownok === true) {
                    this.crownokCSSArray[38] = true;
                }
                if (this.crownother === true) {
                    this.crownotherCSSArray[38] = true;
                }
            }
            else {
                this.crownokCSSArray[38] = false;
                this.crownotherCSSArray[38] = false;
            }
        }
    }
    ...
    onlayFnValue(mode) {
        if (mode === 'tooth18') {
            if (this.teeth18 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[18] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[18] = true;
                }
            }
            else {
                this.onlayokCSSArray[18] = false;
                this.onlayotherCSSArray[18] = false;
            }
        }
        if (mode === 'tooth17') {
            if (this.teeth17 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[17] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[17] = true;
                }
            }
            else {
                this.onlayokCSSArray[17] = false;
                this.onlayotherCSSArray[17] = false;
            }
        }
        if (mode === 'tooth16') {
            if (this.teeth16 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[16] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[16] = true;
                }
            }
            else {
                this.onlayokCSSArray[16] = false;
                this.onlayotherCSSArray[16] = false;
            }
        }
        if (mode === 'tooth15') {
            if (this.teeth15 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[15] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[15] = true;
                }
            }
            else {
                this.onlayokCSSArray[15] = false;
                this.onlayotherCSSArray[15] = false;
            }
        }
        if (mode === 'tooth14') {
            if (this.teeth14 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[14] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[14] = true;
                }
            }
            else {
                this.onlayokCSSArray[14] = false;
                this.onlayotherCSSArray[14] = false;
            }
        }
        if (mode === 'tooth13') {
            if (this.teeth13 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[13] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[13] = true;
                }
            }
            else {
                this.onlayokCSSArray[13] = false;
                this.onlayotherCSSArray[13] = false;
            }
        }
        if (mode === 'tooth12') {
            if (this.teeth12 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[12] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[12] = true;
                }
            }
            else {
                this.onlayokCSSArray[12] = false;
                this.onlayotherCSSArray[12] = false;
            }
        }
        if (mode === 'tooth11') {
            if (this.teeth11 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[11] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[11] = true;
                }
            }
            else {
                this.onlayokCSSArray[11] = false;
                this.onlayotherCSSArray[11] = false;
            }
        }
        if (mode === 'tooth21') {
            if (this.teeth21 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[21] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[21] = true;
                }
            }
            else {
                this.onlayokCSSArray[21] = false;
                this.onlayotherCSSArray[21] = false;
            }
        }
        if (mode === 'tooth22') {
            if (this.teeth22 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[22] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[22] = true;
                }
            }
            else {
                this.onlayokCSSArray[22] = false;
                this.onlayotherCSSArray[22] = false;
            }
        }
        if (mode === 'tooth23') {
            if (this.teeth23 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[23] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[23] = true;
                }
            }
            else {
                this.onlayokCSSArray[23] = false;
                this.onlayotherCSSArray[23] = false;
            }
        }
        if (mode === 'tooth24') {
            if (this.teeth24 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[24] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[24] = true;
                }
            }
            else {
                this.onlayokCSSArray[24] = false;
                this.onlayotherCSSArray[24] = false;
            }
        }
        if (mode === 'tooth25') {
            if (this.teeth25 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[25] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[25] = true;
                }
            }
            else {
                this.onlayokCSSArray[25] = false;
                this.onlayotherCSSArray[25] = false;
            }
        }
        if (mode === 'tooth26') {
            if (this.teeth26 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[26] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[26] = true;
                }
            }
            else {
                this.onlayokCSSArray[26] = false;
                this.onlayotherCSSArray[26] = false;
            }
        }
        if (mode === 'tooth27') {
            if (this.teeth27 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[27] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[27] = true;
                }
            }
            else {
                this.onlayokCSSArray[27] = false;
                this.onlayotherCSSArray[27] = false;
            }
        }
        if (mode === 'tooth28') {
            if (this.teeth28 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[28] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[28] = true;
                }
            }
            else {
                this.onlayokCSSArray[28] = false;
                this.onlayotherCSSArray[28] = false;
            }
        }
        if (mode === 'tooth48') {
            if (this.teeth48 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[48] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[48] = true;
                }
            }
            else {
                this.onlayokCSSArray[48] = false;
                this.onlayotherCSSArray[48] = false;
            }
        }
        if (mode === 'tooth47') {
            if (this.teeth47 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[47] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[47] = true;
                }
            }
            else {
                this.onlayokCSSArray[47] = false;
                this.onlayotherCSSArray[47] = false;
            }
        }
        if (mode === 'tooth46') {
            if (this.teeth46 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[46] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[46] = true;
                }
            }
            else {
                this.onlayokCSSArray[46] = false;
                this.onlayotherCSSArray[46] = false;
            }
        }
        if (mode === 'tooth45') {
            if (this.teeth45 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[45] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[45] = true;
                }
            }
            else {
                this.onlayokCSSArray[45] = false;
                this.onlayotherCSSArray[45] = false;
            }
        }
        if (mode === 'tooth44') {
            if (this.teeth44 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[44] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[44] = true;
                }
            }
            else {
                this.onlayokCSSArray[44] = false;
                this.onlayotherCSSArray[44] = false;
            }
        }
        if (mode === 'tooth43') {
            if (this.teeth43 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[43] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[43] = true;
                }
            }
            else {
                this.onlayokCSSArray[43] = false;
                this.onlayotherCSSArray[43] = false;
            }
        }
        if (mode === 'tooth42') {
            if (this.teeth42 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[42] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[42] = true;
                }
            }
            else {
                this.onlayokCSSArray[42] = false;
                this.onlayotherCSSArray[42] = false;
            }
        }
        if (mode === 'tooth41') {
            if (this.teeth41 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[41] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[41] = true;
                }
            }
            else {
                this.onlayokCSSArray[41] = false;
                this.onlayotherCSSArray[41] = false;
            }
        }
        if (mode === 'tooth31') {
            if (this.teeth31 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[31] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[31] = true;
                }
            }
            else {
                this.onlayokCSSArray[31] = false;
                this.onlayotherCSSArray[31] = false;
            }
        }
        if (mode === 'tooth32') {
            if (this.teeth32 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[32] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[32] = true;
                }
            }
            else {
                this.onlayokCSSArray[32] = false;
                this.onlayotherCSSArray[32] = false;
            }
        }
        if (mode === 'tooth33') {
            if (this.teeth33 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[33] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[33] = true;
                }
            }
            else {
                this.onlayokCSSArray[33] = false;
                this.onlayotherCSSArray[33] = false;
            }
        }
        if (mode === 'tooth34') {
            if (this.teeth34 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[34] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[34] = true;
                }
            }
            else {
                this.onlayokCSSArray[34] = false;
                this.onlayotherCSSArray[34] = false;
            }
        }
        if (mode === 'tooth35') {
            if (this.teeth35 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[35] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[35] = true;
                }
            }
            else {
                this.onlayokCSSArray[35] = false;
                this.onlayotherCSSArray[35] = false;
            }
        }
        if (mode === 'tooth36') {
            if (this.teeth36 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[36] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[36] = true;
                }
            }
            else {
                this.onlayokCSSArray[36] = false;
                this.onlayotherCSSArray[36] = false;
            }
        }
        if (mode === 'tooth37') {
            if (this.teeth37 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[37] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[37] = true;
                }
            }
            else {
                this.onlayokCSSArray[37] = false;
                this.onlayotherCSSArray[37] = false;
            }
        }
        if (mode === 'tooth38') {
            if (this.teeth38 === false) {
                if (this.onlayok === true) {
                    this.onlayokCSSArray[38] = true;
                }
                if (this.onlayother === true) {
                    this.onlayotherCSSArray[38] = true;
                }
            }
            else {
                this.onlayokCSSArray[38] = false;
                this.onlayotherCSSArray[38] = false;
            }
        }
    }
    ...
    RestorationColorcheckboxHide(value, checkboxValue, event) {
        if (value === 'OK' && this.RestorativeOther === false) {
            this.RestorativeOther = true;
            this.ROK = true;
            this.ROther = false;
        }
        else if (value === 'other' && this.RestorativeOk === false) {
            this.RestorativeOk = true;
            this.ROther = true;
            this.ROK = false;
        }
    ...
    ColorCssFn(mode) {
        if (mode === 'tooth18') {
            if (this.teeth18 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[18] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[18] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[18] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[18] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[18] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[18] = false;
                this.ColorDistalCSSArray[18] = false;
                this.ColorLingualCSSArray[18] = false;
                this.ColorOcclusalCSSArray[18] = false;
        ...
        if (mode === 'tooth17') {
            if (this.teeth17 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[17] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[17] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[17] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[17] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[17] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[17] = false;
                this.ColorDistalCSSArray[17] = false;
                this.ColorLingualCSSArray[17] = false;
                this.ColorOcclusalCSSArray[17] = false;
        ...
        if (mode === 'tooth16') {
            if (this.teeth16 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[16] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[16] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[16] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[16] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[16] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[16] = false;
                this.ColorDistalCSSArray[16] = false;
                this.ColorLingualCSSArray[16] = false;
                this.ColorOcclusalCSSArray[16] = false;
        ...
        if (mode === 'tooth15') {
            if (this.teeth15 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[15] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[15] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[15] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[15] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[15] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[15] = false;
                this.ColorDistalCSSArray[15] = false;
                this.ColorLingualCSSArray[15] = false;
                this.ColorOcclusalCSSArray[15] = false;
        ...
        if (mode === 'tooth14') {
            if (this.teeth14 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[14] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[14] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[14] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[14] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[14] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[14] = false;
                this.ColorDistalCSSArray[14] = false;
                this.ColorLingualCSSArray[14] = false;
                this.ColorOcclusalCSSArray[14] = false;
        ...
        if (mode === 'tooth13') {
            if (this.teeth13 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[13] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[13] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[13] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[13] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[13] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[13] = false;
                this.ColorDistalCSSArray[13] = false;
                this.ColorLingualCSSArray[13] = false;
                this.ColorOcclusalCSSArray[13] = false;
        ...
        if (mode === 'tooth12') {
            if (this.teeth12 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[12] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[12] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[12] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[12] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[12] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[12] = false;
                this.ColorDistalCSSArray[12] = false;
                this.ColorLingualCSSArray[12] = false;
                this.ColorOcclusalCSSArray[12] = false;
        ...
        if (mode === 'tooth11') {
            if (this.teeth11 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[11] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[11] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[11] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[11] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[11] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[11] = false;
                this.ColorDistalCSSArray[11] = false;
                this.ColorLingualCSSArray[11] = false;
                this.ColorOcclusalCSSArray[11] = false;
        ...
        if (mode === 'tooth21') {
            if (this.teeth21 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[21] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[21] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[21] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[21] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[21] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[21] = false;
                this.ColorDistalCSSArray[21] = false;
                this.ColorLingualCSSArray[21] = false;
                this.ColorOcclusalCSSArray[21] = false;
        ...
        if (mode === 'tooth22') {
            if (this.teeth22 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[22] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[22] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[22] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[22] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[22] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[22] = false;
                this.ColorDistalCSSArray[22] = false;
                this.ColorLingualCSSArray[22] = false;
                this.ColorOcclusalCSSArray[22] = false;
        ...
        if (mode === 'tooth23') {
            if (this.teeth23 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[23] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[23] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[23] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[23] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[23] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[23] = false;
                this.ColorDistalCSSArray[23] = false;
                this.ColorLingualCSSArray[23] = false;
                this.ColorOcclusalCSSArray[23] = false;
        ...
        if (mode === 'tooth24') {
            if (this.teeth24 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[24] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[24] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[24] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[24] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[24] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[24] = false;
                this.ColorDistalCSSArray[24] = false;
                this.ColorLingualCSSArray[24] = false;
                this.ColorOcclusalCSSArray[24] = false;
        ...
        if (mode === 'tooth25') {
            if (this.teeth25 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[25] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[25] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[25] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[25] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[25] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[25] = false;
                this.ColorDistalCSSArray[25] = false;
                this.ColorLingualCSSArray[25] = false;
                this.ColorOcclusalCSSArray[25] = false;
        ...
        if (mode === 'tooth26') {
            if (this.teeth26 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[26] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[26] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[26] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[26] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[26] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[26] = false;
                this.ColorDistalCSSArray[26] = false;
                this.ColorLingualCSSArray[26] = false;
                this.ColorOcclusalCSSArray[26] = false;
        ...
        if (mode === 'tooth27') {
            if (this.teeth27 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[27] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[27] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[27] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[27] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[27] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[27] = false;
                this.ColorDistalCSSArray[27] = false;
                this.ColorLingualCSSArray[27] = false;
                this.ColorOcclusalCSSArray[27] = false;
        ...
        if (mode === 'tooth28') {
            if (this.teeth28 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[28] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[28] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[28] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[28] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[28] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[28] = false;
                this.ColorDistalCSSArray[28] = false;
                this.ColorLingualCSSArray[28] = false;
                this.ColorOcclusalCSSArray[28] = false;
        ...
        if (mode === 'tooth48') {
            if (this.teeth48 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[48] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[48] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[48] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[48] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[48] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[48] = false;
                this.ColorDistalCSSArray[48] = false;
                this.ColorLingualCSSArray[48] = false;
                this.ColorOcclusalCSSArray[48] = false;
        ...
        if (mode === 'tooth47') {
            if (this.teeth47 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[47] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[47] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[47] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[47] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[47] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[47] = false;
                this.ColorDistalCSSArray[47] = false;
                this.ColorLingualCSSArray[47] = false;
                this.ColorOcclusalCSSArray[47] = false;
        ...
        if (mode === 'tooth46') {
            if (this.teeth46 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[46] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[46] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[46] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[46] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[46] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[46] = false;
                this.ColorDistalCSSArray[46] = false;
                this.ColorLingualCSSArray[46] = false;
                this.ColorOcclusalCSSArray[46] = false;
        ...
        if (mode === 'tooth45') {
            if (this.teeth45 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[45] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[45] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[45] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[45] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[45] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[45] = false;
                this.ColorDistalCSSArray[45] = false;
                this.ColorLingualCSSArray[45] = false;
                this.ColorOcclusalCSSArray[45] = false;
        ...
        if (mode === 'tooth44') {
            if (this.teeth44 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[44] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[44] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[44] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[44] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[44] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[44] = false;
                this.ColorDistalCSSArray[44] = false;
                this.ColorLingualCSSArray[44] = false;
                this.ColorOcclusalCSSArray[44] = false;
        ...
        if (mode === 'tooth43') {
            if (this.teeth43 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[43] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[43] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[43] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[43] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[43] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[43] = false;
                this.ColorDistalCSSArray[43] = false;
                this.ColorLingualCSSArray[43] = false;
                this.ColorOcclusalCSSArray[43] = false;
        ...
        if (mode === 'tooth42') {
            if (this.teeth42 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[42] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[42] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[42] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[42] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[42] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[42] = false;
                this.ColorDistalCSSArray[42] = false;
                this.ColorLingualCSSArray[42] = false;
                this.ColorOcclusalCSSArray[42] = false;
        ...
        if (mode === 'tooth41') {
            if (this.teeth41 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[41] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[41] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[41] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[41] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[41] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[41] = false;
                this.ColorDistalCSSArray[41] = false;
                this.ColorLingualCSSArray[41] = false;
                this.ColorOcclusalCSSArray[41] = false;
        ...
        if (mode === 'tooth31') {
            if (this.teeth31 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[31] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[31] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[31] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[31] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[31] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[31] = false;
                this.ColorDistalCSSArray[31] = false;
                this.ColorLingualCSSArray[31] = false;
                this.ColorOcclusalCSSArray[31] = false;
        ...
        if (mode === 'tooth32') {
            if (this.teeth32 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[32] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[32] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[32] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[32] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[32] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[32] = false;
                this.ColorDistalCSSArray[32] = false;
                this.ColorLingualCSSArray[32] = false;
                this.ColorOcclusalCSSArray[32] = false;
        ...
        if (mode === 'tooth33') {
            if (this.teeth33 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[33] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[33] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[33] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[33] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[33] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[33] = false;
                this.ColorDistalCSSArray[33] = false;
                this.ColorLingualCSSArray[33] = false;
                this.ColorOcclusalCSSArray[33] = false;
        ...
        if (mode === 'tooth34') {
            if (this.teeth34 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[34] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[34] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[34] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[34] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[34] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[34] = false;
                this.ColorDistalCSSArray[34] = false;
                this.ColorLingualCSSArray[34] = false;
                this.ColorOcclusalCSSArray[34] = false;
        ...
        if (mode === 'tooth35') {
            if (this.teeth35 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[35] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[35] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[35] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[35] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[35] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[35] = false;
                this.ColorDistalCSSArray[35] = false;
                this.ColorLingualCSSArray[35] = false;
                this.ColorOcclusalCSSArray[35] = false;
        ...
        if (mode === 'tooth36') {
            if (this.teeth36 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[36] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[36] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[36] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[36] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[36] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[36] = false;
                this.ColorDistalCSSArray[36] = false;
                this.ColorLingualCSSArray[36] = false;
                this.ColorOcclusalCSSArray[36] = false;
        ...
        if (mode === 'tooth37') {
            if (this.teeth37 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[37] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[37] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[37] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[37] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[37] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[37] = false;
                this.ColorDistalCSSArray[37] = false;
                this.ColorLingualCSSArray[37] = false;
                this.ColorOcclusalCSSArray[37] = false;
        ...
        if (mode === 'tooth38') {
            if (this.teeth38 === false) {
                if (this.ColorMesialchecked === true) {
                    this.ColorMesialCSSArray[38] = true;
                }
                if (this.ColorDistalchecked === true) {
                    this.ColorDistalCSSArray[38] = true;
                }
                if (this.ColorLingualchecked === true) {
                    this.ColorLingualCSSArray[38] = true;
                }
                if (this.ColorOcclusalchecked === true) {
                    this.ColorOcclusalCSSArray[38] = true;
                }
                if (this.ColorBuccalchecked === true) {
                    this.ColorBuccalCSSArray[38] = true;
                }
            }
            else {
                this.ColorMesialCSSArray[38] = false;
                this.ColorDistalCSSArray[38] = false;
                this.ColorLingualCSSArray[38] = false;
                this.ColorOcclusalCSSArray[38] = false;
    ...
    updatePatientName() {
        ...
        this.adminService.updatePatientName(data).subscribe(data1 => {
    ...
    CariesFormSubmit() {
        this.adminService.saveTeethDiagnose(this.CariesForms, this.cariesTagValue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Caries save', 'data saved');
            console.log(data);
        });
    }
    FractureFormSubmit() {
        this.adminService.saveTeethDiagnose(this.FractureForms, this.cariesTagValue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Fracture save', 'data saved');
            console.log(data);
        });
    }
    SeverelyDamagedFormSubmit() {
        this.adminService.saveTeethDiagnose(this.SeverelyDamagedForms, this.cariesTagValue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Severely Damaged save', 'data saved');
            console.log(data);
        });
    }
    WearFormsSubmit() {
        this.adminService.saveTeethDiagnose(this.WearForms, this.cariesTagValue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Wear save', 'data saved');
            console.log(data);
        });
    }
    PlaqueHygieneFormsSubmit() {
        this.adminService.saveTeethDiagnosePerioBone(this.PlaqueHygieneForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Plaque & Hygiene save', 'data saved');
            console.log(data);
        });
    }
    GingivitisFormsSubmit() {
        this.adminService.saveTeethDiagnosePerioBone(this.GingivitisForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Gingivitis save', 'data saved');
            console.log(data);
        });
    }
    GingivalRecessionFormsSubmit() {
        this.adminService.saveTeethDiagnosePerioBone(this.GingivalRecessionForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Gingival Recession save', 'data saved');
            console.log(data);
        });
    }
    PeriodontitisFormsSubmit() {
        this.adminService.saveTeethDiagnosePerioBone(this.PeriodontitisForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Periodontitis save', 'data saved');
            console.log(data);
        });
    }
    MobilityFormsSubmit() {
        this.adminService.saveTeethDiagnosePerioBone(this.MobilityForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Mobility save', 'data saved');
            console.log(data);
        });
    }
    GummySmileFormsSubmit() {
        this.adminService.saveTeethDiagnosePerioBone(this.GummySmileForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('GummySmile save', 'data saved');
            console.log(data);
        });
    }
    GingivalOvergrowthFormsSubmit() {
        this.adminService.saveTeethDiagnosePerioBone(this.GingivalOvergrowthForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Gingival Overgrowth save', 'data saved');
            console.log(data);
        });
    }
    LargeMaxillarySinusFormsSubmit() {
        this.adminService.saveTeethDiagnosePerioBone(this.LargeMaxillarySinusForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Large Maxillary Sinus save', 'data saved');
            console.log(data);
        });
    }
    necrosisFormsSubmit() {
        this.adminService.saveTeethDiagnoseEndodontics(this.NecrosisForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Necrosis save', 'data saved');
            console.log(data);
        });
    }
    rootCanalTreatmentFormsSubmit() {
        this.adminService.saveTeethDiagnoseEndodontics(this.RootCanalTreatmentForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Root Canal Treatment save', 'data saved');
            console.log(data);
        });
    }
    apicalLesioFormsSubmit() {
        this.adminService.saveTeethDiagnoseEndodontics(this.ApicalLesioForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Apical Lesio save', 'data saved');
            console.log(data);
        });
    }
    brokenInstrumentinCanalForms() {
        this.adminService.saveTeethDiagnoseEndodontics(this.BrokenInstrumentinCanalForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Broken Instrument in Canal save', 'data saved');
            console.log(data);
        });
    }
    rootResorptionForms() {
        this.adminService.saveTeethDiagnoseEndodontics(this.RootResorptionForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
            this.showSuccess('Root Resorption save', 'data saved');
            console.log(data);
        });
    }
    missingTeeth() {
        this.adminService.saveTeethDiagnoseMissingTeethImplants(this.RootResorptionForms, this.Periotagvalue, this.selectedTeethValueString, this.PatientID).subscribe(data => {
