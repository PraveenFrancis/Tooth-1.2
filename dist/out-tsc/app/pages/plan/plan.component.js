...
let PlanComponent = class PlanComponent {
    constructor(adminService, toastrService) {
        ...
        this.type = '';
        this.typeB = false;
        this.BoneRegenerationCSSArray = new Array();
        this.BoneRegeneration = false;
        this.RootCanalTreatmentCSSArray = new Array();
        this.rootCanalTreatment = false;
        this.apicectomy = false;
        this.apicectomyCssArray = new Array();
        this.Implant = false;
        this.ImplantCSSArray = new Array();
        this.RestorationValue = [];
        this.RBuccal = false;
        this.RBuccalCSSarray = new Array();
        this.RDistal = false;
        this.RDistalCSSarray = new Array();
        this.RLingual = false;
        this.RLingualCSSarray = new Array();
        this.RMesial = false;
        this.RMesialCSSarray = new Array();
        this.ROcclusal = false;
        this.ROcclusalCSSarray = new Array();
        this.RPost = false;
        this.RExternalBleach = false;
        this.RInternalBleach = false;
        this.RCoreBuildUp = false;
        this.CoreBuildUpValue = [];
        this.CBuccal = false;
        this.CBuccalCSSarray = new Array();
        this.CDistal = false;
        this.CDistalCSSarray = new Array();
        this.CLingual = false;
        this.CLingualCSSarray = new Array();
        this.CMesial = false;
        this.CMesialCSSarray = new Array();
        this.COcclusal = false;
        this.COcclusalCSSarray = new Array();
        this.provisionalRestoration = false;
        this.ProvisionalRestorationValue = [];
        this.PBuccal = false;
        this.PBuccalCSSarray = new Array();
        this.PDistal = false;
        this.PDistalCSSarray = new Array();
        this.PLingual = false;
        this.PLingualCSSarray = new Array();
        this.PMesial = false;
        this.PMesialCSSarray = new Array();
        this.POcclusal = false;
        this.POcclusalCSSarray = new Array();
        // 
        this.PVeneer = false;
        this.PVeneerCSSArray = new Array();
        this.POnlay = false;
        this.POnlayCSSArray = new Array();
        this.PCrown = false;
        this.PCrownCSSArray = new Array();
        this.DentureVar = false;
        this.ChromeCobalt = false;
        this.ChromeCobaltCssArray = new Array();
        this.Acrylic = false;
        this.AcrylicCssArray = new Array();
        this.DentureValue = [];
    }
    ngOnInit() {
    ...
    teeth(mode, teethValue) {
        ...
        if (mode === 'tooth21') {
            if (this.teeth21 === false) {
                this.teeth21 = true;
                if (this.BoneRegeneration === true) {
                    this.BoneRegenerationCSSArray[21] = true;
                }
                if (this.rootCanalTreatment === true) {
    ...
    DentureRadio(value) {
        if (value === 'Chrome Cobalt') {
            ...
            if (findvalue === -1) {
                this.DentureValue.push(value);
            }
            if (findDvalue !== -1) {
                this.DentureValue.splice(findDvalue, 1);
            }
    ...
    OrthoTab(value) {
        this.treatment = value;
        if (value === 'Fixed Braces') {
            this.typeB = true;
        }
        else if (value !== 'Fixed Braces') {
            this.typeB = false;
        }
    }
    FixedBraces(value) {
    ...
    pl_form(tablename, price, date, message, stage) {
        this.bodydata.PatientID = this.id;
        this.bodydata.tablename = tablename;
        this.bodydata.price = price;
        this.bodydata.date = date;
        this.bodydata.message = message;
        this.bodydata.stage = stage;
