...
export class PlanDetailsComponent implements OnInit {
  ...
  VeneerForms = {Ok: false , Leaking: false , Worn: false, Fractured: false, Discolored: false, Unaesthetic: false};
  CrownForms = {Ok: false , Leaking: false , Worn: false, Fractured: false, Discolored: false, Unaesthetic: false};
  OnlayForms = {Ok: false , Leaking: false , Worn: false, Fractured: false, Discolored: false, Unaesthetic: false};
  BridgeForms = {Ok: false , Leaking: false , Worn: false, Fractured: false, Discolored: false, Unaesthetic: false};
  DentureForms = {Ok: false , Leaking: false , Worn: false, Fractured: false, Discolored: false, Unaesthetic: false};
  ...
  // -------------main----------------
  cariesTagValue: any;
  CariesFracturesWear = true;
  FractureValue = '';
  WearValue = '';
  PerioBone = false;
  Endodontics = false;
  MissingteethImplants = false;
...
rootSection = false;
fractures = [];
crownCSSarray = new Array();
rootCSSarray = new Array();


// SeverelyDamaged
severalDamaged = false;
severalDamagedLabel = [];
severalDamagedCSSarray = new Array();

//  wear section
wearActive = false;
wear = [];
MildSection = false;
ModerateSection = false;
SevereSection = false;
MildCSSarray = new Array();
ModerateCSSarray = new Array();
SevereCSSarray = new Array();
// -------------------------Perio Bone Section----------------------
PlaqueHygieneDegree = [];
GingivitisDegree = [];
MobilityDegree = [];
...
GingivalRecessionactive = true;
GingivalRecessionDegree = [];
GingivalRecessionMild = false;
GingivalRecessionMildCSSArray = new Array();
GingivalRecessionModerate = false;
GingivalRecessionModerateCSSArray = new Array();
GingivalRecessionSevere = false;
GingivalRecessionSevereCSSArray = new Array();

PeriodontitisActive = true;
PeriodontitisDegree = [];
PeriodontitisMild = false;
PeriodontitisMildCSSArray = new Array();
PeriodontitisModerate = false;
PeriodontitisModerateCSSArray = new Array();
PeriodontitisSevere = false;
PeriodontitisSevereCSSArray = new Array();

GummSmileActive = false;
GummSmileCSSArray = new Array();

GingivalOvergrowthActive = false;
GingivalOvergrowthCSSArray = new Array();

// tab 3
ApicalLesionDegree = [];
necrosisCSSArray = new Array();
necrosis = false;
RootCanalTreatment = false;

SatisfactoryCSSArray = new Array();
saticfactory = false;

UnsatisfactoryCSSArray = new Array();
unsatisfactory = false;

ApicalLesionMild = false;
ApicalLesionMildCSSArray = new Array();
ApicalLesionModerate = false;
ApicalLesionModerateCSSArray = new Array();
ApicalLesionSevere = false;
ApicalLesionSevereCSSArray = new Array();

BrokenInstrumentinCanal = false;
BrokenInstrumentinCanalCSSArray = new Array();

RootResorption = [];
InternalCSSarray = new Array();
Internalchecked = false;
ExternalCSSarray = new Array();
...
checkBoxValue = [];
checkBoxOk = [];
otherCSSArray = new Array();
okCSSArray = new Array();

teethhidden = false;
MissingTeethActive = false;
MissingTeethCSSArray = new Array();

ImpactedTeethActive = false;
ImpactedTeethCSSArray = new Array();

ImpactedInfectedTeethActive = false;
ImpactedInfectedTeethCSSArray = new Array();

LargeMaxillarySinusActive = false;
LargeMaxillarySinusCSSArray = new Array();

// tab 6

postokCSSArray = new Array();
postok = false;

postunsatisfactoryCSSArray = new Array();
postunsatisfactory = false;


DiscoloredTeethActive = false;
DiscoloredCSSArray = new Array();
...
crowncheckBoxValue = [];
crowncheckBoxOk = [];
crownotherCSSArray = new Array();
crownokCSSArray = new Array();
...
onlaycheckBoxValue = [];
onlaycheckBoxOk = [];
onlayotherCSSArray = new Array();
onlayokCSSArray = new Array();
...
ROther = false;
RestorativeOk = false;
RestorativeOther = false;
RColor = [];
ColorBuccalchecked = false;
ColorBuccalCSSArray = new Array();
ColorDistalchecked = false;
ColorDistalCSSArray = new Array();
ColorLingualchecked = false;
ColorLingualCSSArray = new Array();
ColorMesialchecked = false;
ColorMesialCSSArray = new Array();
ColorOcclusalchecked = false;
...
public PatientID = parseInt(this.route.snapshot.paramMap.get('PatientID'), 10);
  ...
  multiSelectTeeth(id) {
    if (id === '1'){ if (this.teeth18 === false && this.teeth17 === false && this.teeth16 === false &&  this.teeth15 === false && 
        ...
        }  else { this.teeth18 = false; this.teeth17 = false; this.teeth16 = false; this.teeth15 = false;
           this.teeth14 = false; this.teeth13 = false; this.teeth12 = false; this.teeth11 = false; 
        ...
        if (id === '2'){ if (this.teeth21 === false && this.teeth22 === false && this.teeth23 === false &&  this.teeth24 === false && this.teeth25 === false && this.teeth26 === false && this.teeth27 === false && this.teeth28 === false) {
        ...
        } else { this.teeth21 = false; this.teeth22 = false; this.teeth23 = false; this.teeth24 = false; this.teeth25 = false;
          ...
          if (id === '3'){ if (this.teeth48 === false && this.teeth47 === false && this.teeth46 === false &&  this.teeth45 === false && this.teeth44 === false && this.teeth43 === false && this.teeth42 === false && this.teeth41 === false) {
              ...
              if (this.DiscoloredTeethActive === true ) {
                ...
                } else { this.teeth48 = false; this.teeth47 = false; this.teeth46 = false; this.teeth45 = false; this.teeth44 = false; 
                  ...
                  this.DiscoloredCSSArray[41] = false;
                   ...
                   this.selectedTeethValueString = this.selectedTeethValue.join(); }
          if (id === '4'){ if (this.teeth31 === false && this.teeth32 === false && this.teeth33 === false &&  this.teeth34 === false && this.teeth35 === false && this.teeth36 === false && this.teeth37 === false && this.teeth38 === false) {
              ...
              if (this.DiscoloredTeethActive === true ) {
                ...
                this.DiscoloredCSSArray[38] = true;
                    ...
                    }  else { this.teeth31 = false; this.teeth32 = false; this.teeth33 = false; this.teeth34 = false; this.teeth35 = false; 
  ...
  showOFT() { if (this.oftHide === false) { this.oftHide = true; this.malocclusion = true; this.facial = false; this.tmj = false;
  ...
  Button1() { if(this.classII === false && this.classI === true) {this.classI = false; this.classII = true; }
            else if (this.classIII === true && this.classI === false) {this.classII = true; this.classI = false; this.classIII = false;
           } else if(this.classII === true && this.classI === false) { this.classI = true; this.classII = false;}}
  Button2() { if(this.classIII === false && this.classI === true) { this.classI = false; this.classIII = true; }
  ...
  buttonT1() { if(this.class2 === false && this.class1 === true) {this.class1 = false; this.class2 = true; } 
            else if (this.class3 === true && this.class1 === false) { this.class2 = true;  this.class1 = false;  this.class3 = false;
            } else if(this.class2 === true && this.class1 === false) { this.class1 = true;  this.class2 = false; }}
  buttonT2() {if(this.class3 === false && this.class1 === true) { this.class1 = false; this.class3 = true; } 
  ...
  buttonT11() { if(this.class12 === false && this.class11 === true) { this.class11 = false;  this.class12 = true; } else if 
             (this.class13 === true && this.class11 === false) { this.class12 = true; this.class11 = false; this.class13 = false;
            } else if(this.class12 === true && this.class11 === false) { this.class11 = true; this.class12 = false; }}
buttonT12() { if(this.class13 === false && this.class11 === true) { this.class11 = false; this.class13 = true; } else if 
  ...
  Button12(){if(this.crowding2 === false){this.crowding2 = true; this.crowding1 = false; }else{ this.crowding2 = false; 
            this.crowding1 = true; }}

  Button13(){if(this.spacing2 === false) {this.spacing2 = true; this.spacing1 = false; } else { this.spacing2 = false; this.spacing1 = true;
             }}

  Button14(){if(this.posterior2 === false) {this.posterior2 = true; this.posterior1 = false;} else 
            { this.posterior2 = false; this.posterior1 = true;}}

  Button15(){ if(this.skeletal2 === false) { this.skeletal2 = true; this.skeletal1 = false; } else 
            { this.skeletal2 = false; this.skeletal1 = true; }}
  ...
  vaneerFnValue(mode) {
    if (mode === 'tooth18') { if (this.teeth18 === false ) { 
   ...
   if (mode === 'tooth17') {if (this.teeth17 === false ) { 
  ...
  if (mode === 'tooth16') {if (this.teeth16 === false ) { 
  ...
  if (mode === 'tooth15') {if (this.teeth15 === false ) { 
      ...
      if (mode === 'tooth14') {if (this.teeth14 === false ) { 
      ...
      if (mode === 'tooth13') {if (this.teeth13 === false ) { 
      ...
      if (mode === 'tooth12') {if (this.teeth12 === false ) { 
      ...
      if (mode === 'tooth11') {if (this.teeth11 === false ) { 
      ...
      if (mode === 'tooth21') {if (this.teeth21 === false ) { 
      ...
      if (mode === 'tooth22') {if (this.teeth22 === false ) { 
      ...
      if (mode === 'tooth23') {if (this.teeth23 === false ) { 
      ...
      if (mode === 'tooth24') {if (this.teeth24 === false ) { 
      ...
      if (mode === 'tooth25') {if (this.teeth25 === false ) { 
      ...
      if (mode === 'tooth26') {if (this.teeth26 === false ) { 
      ...
      if (mode === 'tooth27') {if (this.teeth27 === false ) { 
      ...
      if (mode === 'tooth28') {if (this.teeth28 === false ) { 
      ...
      if (mode === 'tooth48') {if (this.teeth48 === false ) { 
      ...
      if (mode === 'tooth47') {if (this.teeth47 === false ) { 
      ...
      if (mode === 'tooth46') {if (this.teeth46 === false ) { 
      ...
      if (mode === 'tooth45') {if (this.teeth45 === false ) { 
      ...
      if (mode === 'tooth44') {if (this.teeth44 === false ) { 
      ...
      if (mode === 'tooth43') {if (this.teeth43 === false ) { 
      ...
      if (mode === 'tooth42') {if (this.teeth42 === false ) { 
      ...
      if (mode === 'tooth41') {if (this.teeth41 === false ) { 
      ...
      if (mode === 'tooth31') {if (this.teeth31 === false ) { 
      ...
      if (mode === 'tooth32') {if (this.teeth32 === false ) { 
      ...
      if (mode === 'tooth33') {if (this.teeth33 === false ) { 
      ...
      if (mode === 'tooth34') {if (this.teeth34 === false ) { 
      ...
      if (mode === 'tooth35') {if (this.teeth35 === false ) { 
      ...
      if (mode === 'tooth36') {if (this.teeth36 === false ) { 
      ...
      if (mode === 'tooth37') {if (this.teeth37 === false ) { 
      ...
      if (mode === 'tooth38') {if (this.teeth38 === false ) { 
...
if (mode === 'tooth15') {if (this.teeth15 === false ) { 
  ...
  FractureFormSubmit() {
    this.adminService.saveTeethDiagnose(this.FractureForms, this.cariesTagValue,
    this.selectedTeethValueString , this.PatientID).subscribe(data => {
